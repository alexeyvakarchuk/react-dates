...
var propTypes = (0, _airbnbPropTypes.forbidExtraProps)((0, _object2['default'])({}, _reactWithStyles.withStylesPropTypes, {
  ...
  // custom controls
  DayPickerControls: _propTypes2['default'].element
}));
    ...
    value: function () {
      function render() {
        ...
        return _react2['default'].createElement('div', _extends({
          ...
          phrases: phrases
        })), renderCalendarInfo && renderCalendarInfo(), _react2['default'].createElement('div', { className: 'DayPicker-controls' }, this.props.DayPickerControls)));
      }
